...
import { Building2, FileText, TrendingUp, CreditCard } from "lucide-react"
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage your corporate tax compliance
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">For current FY</p>
          </CardContent>
        </Card>
